...
class DoctrineMetadata1Test extends \Laminas\Test\PHPUnit\Controller\AbstractHttpControllerTestCase
{
    ...
    public function testDoctrineMetadataResource()
    {
        ...
        $this->dispatch('/api-tools/api/doctrine/doctrine.entitymanager.orm_default/metadata/Db%5CEntity%5CArtist', Request::METHOD_GET);
