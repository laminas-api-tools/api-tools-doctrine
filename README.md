...
```sh
$ php composer.phar require laminas-api-tools/api-tools-doctrine "~0.3"
```
...
This is a Doctrine resource creation route _like_ Laminas API Tools Rest `/api-tools/api/module[/:name]/rest[/:controller_service_name]`
POST Parameters:
