...
return array(
    'service_manager' => array(
        ...
        'factories' => array(
            ...
            'LaminasApiToolsDoctrineQueryCreateFilterManager' =>
                'Laminas\ApiTools\Doctrine\Server\Query\CreateFilter\Service\QueryCreateFilterManagerFactory',
        ),
    ),
    ...
    'api-tools-doctrine-query-create-filter' => array(
        'invokables' => array(
            'default' => 'Laminas\ApiTools\Doctrine\Server\Query\CreateFilter\DefaultCreateFilter',
        )
    ),
