...
return array(
    'router' => array(
        'routes' => array(
            ...
            'api-tools-doctrine-autodiscovery' => array(
                'type' => 'segment',
                'options' => array(
                    'route' => '/api-tools/api/module/:name/:version/autodiscovery/doctrine/:object_manager_alias',
                    'defaults' => array(
                        'controller' => 'Laminas\ApiTools\Doctrine\Admin\Controller\DoctrineAutodiscovery',
                        'action' => 'discover',
                    ),
                ),
            ),
    ...
    'controllers' => array(
        'factories' => array(
            'Laminas\ApiTools\Doctrine\Admin\Controller\DoctrineAutodiscovery' => 'Laminas\ApiTools\Doctrine\Admin\Controller\DoctrineAutodiscoveryControllerFactory'
        ),
    ),

    'api-tools-content-negotiation' => array(
        'controllers' => array(
            'Laminas\ApiTools\Doctrine\Admin\Controller\DoctrineAutodiscovery'   => 'Json',
        ...
        'accept-whitelist' => array(
            'Laminas\ApiTools\Doctrine\Admin\Controller\DoctrineAutodiscovery' => array(
                'application/json',
                'application/*+json',
            ),
